...
app.config.from_object('Quack.config')
...
import Quack.views  # noqa: E402  pylint: disable=wrong-import-position
import Quack.model  # noqa: E402  pylint: disable=wrong-import-position
